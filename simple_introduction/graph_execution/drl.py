    ...
    for episode_id in range(num_episodes):
        ...
        for t in range(max_len_episode):
            ...
            if len(replay_buffer) >= batch_size:
                ...
                q_value = sess.run(model(tf.constant(batch_next_state, dtype=tf.float32)))
                ...
                sess.run([loss, train_op], feed_dict={y_placeholder: y, predictions_placeholder: predictions})